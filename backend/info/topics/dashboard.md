...
| Weekly missing-reflection Slack | Celery `accounts.tasks.notify_missing_reflections` — configure via **Administration → Notifications** ([SLACK_SETUP.md](../../../docs/SLACK_SETUP.md)) |
